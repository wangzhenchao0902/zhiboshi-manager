...
export async function queryRule(params: TableListParams) {
  ...
  return request('/api/manager/warrantytianchuang', {
    params: {
      ...requestParams,
...
export async function updateRule(id: number, params: TableListParams) {
  return request('/api/manager/warrantytianchuang/'.concat(id.toString()), {
    method: 'PUT',
    data: {
      ...params,
    },
...
export async function voidWarranty(id: number) {
  return request('/api/manager/warrantytianchuang/void/'.concat(id.toString()), {
    method: 'POST',
  });
}
